...
from got10k.experiments import ExperimentNfS
import numpy as np
import os
import sys
import argparse
...
parser = argparse.ArgumentParser(description='Run NFS')
...
if __name__ == '__main__':
    ...
    experiment = ExperimentNfS('/data3/wangning/NFS', fps=30)  ### 30 FPS
